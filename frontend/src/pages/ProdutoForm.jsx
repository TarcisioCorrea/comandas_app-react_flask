        ...
        <Box component="form" onSubmit={handleSubmit(onSubmit)} sx={{ backgroundColor: '#ADD8E6', padding: 2, borderRadius: 1, mt: 2 }}>
            ...
            <Box sx={{ backgroundColor: 'white', padding: 2, borderRadius: 3, mb: 2 }}>
                ...
                <TextField
                    ...
                    {...register('cpf', { required: 'Descrição é obrigatória' })} error={!!errors.descricao} helperText={errors.descricao?.message}
                />
                <TextField
                    label="Foto" fullWidth margin="normal"
                    {...register('matricula', { required: 'Foto é obrigatória' })} error={!!errors.foto} helperText={errors.foto?.message}
                />
                <TextField
                    label="Valor Unitário" fullWidth margin="normal" {...register('valor')}
                />
